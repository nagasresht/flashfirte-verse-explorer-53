        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-gray-900 rounded-xl p-6 shadow-lg">
            ...
            <ul className="space-y-4">
              <li>
                <p className="text-lg">
                  <span className="font-semibold text-cyan-400">Speak-A-Thon  :</span>  9:00 AM-1:00 PM
                </p>
              </li>
              <li>
                <p className="text-lg">
          ...
          <div className="bg-gray-900 rounded-xl p-6 shadow-lg">
            ...
            <ul className="space-y-4">
              <li>
                <p className="text-lg">
                  <span className="font-semibold text-cyan-400">Design-A-Thon :</span> 9:00 AM-1:00 PM
                </p>
              </li>
              <li>
                <p className="text-lg">
                  <span className="font-semibold text-cyan-400">Idea-Thon :</span>  2:00 PM-5:00 PM
                </p>
              </li>
            </ul>
          </div>
