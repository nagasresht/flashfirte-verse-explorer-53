      ...
      <section className="py-20 px-4">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Round 1 */}
            <Card className="bg-gradient-to-br from-purple-900/50 to-pink-900/50 backdrop-blur-md border border-purple-500/30 hover:border-pink-500/40 transition-all duration-300 h-full">
              <CardContent className="p-8 text-center">
                <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
                  Round 1: Theme Reveal
                </h3>
                <p className="text-gray-300 text-lg leading-relaxed">
                  Participants will receive an exciting design theme to showcase their creativity. Submissions must include a brief concept explanation along with the design.
                </p>
              </CardContent>
            </Card>

            {/* Round 2 */}
            <Card className="bg-gradient-to-br from-pink-900/50 to-rose-900/50 backdrop-blur-md border border-pink-500/30 hover:border-rose-500/40 transition-all duration-300 h-full">
              <CardContent className="p-8 text-center">
                <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-pink-400 to-rose-400 bg-clip-text text-transparent">
                  Round 2: Prototype Presentation
                </h3>
                <p className="text-gray-300 text-lg leading-relaxed">
                  Shortlisted teams will present a functional prototype to the judges, explaining their design thinking, process, and impact.
                </p>
              </CardContent>
            </Card>
          </div>
