        ...
        <motion.div style={{ y: y1 }} className="text-center z-10 max-w-4xl mx-auto">
          ...
          >
            <div className="flex items-center justify-center mb-4">
              ...
              <h1 className="text-6xl md:text-8xl font-bold bg-gradient-to-r from-purple-400 via-pink-400 to-rose-400 bg-clip-text text-transparent leading-tight pb-3.5 mt-6 mb-6">
                Design-A-Thon
              </h1>
            </div>
          ...
          >
            <Button
              ...
              className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-8 py-4 text-lg rounded-full shadow-2xl shadow-purple-500/25 hover:shadow-purple-500/40 transition-all duration-300 hover:scale-105 leading-tight pb-4"
            >
            ...
            <Button
              ...
              variant="outline"
              className="border-purple-400 text-purple-400 hover:bg-purple-400 hover:text-white px-8 py-4 text-lg rounded-full transition-all duration-300 leading-tight pb-4"
            >
              <Monitor className="mr-2 w-5 h-5" />
              View Gallery
            </Button>
            <Button className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-8 py-4 text-lg rounded-full shadow-2xl shadow-purple-500/25 hover:shadow-purple-500/40 transition-all duration-300 hover:scale-105 leading-tight pb-4">
